...
if("xfeatures2d" IN_LIST FEATURES)
...
if("contrib" IN_LIST FEATURES)
  ...
  set(OPENCV_EXTRA_MODULES_PATH ${CONTRIB_SOURCE_PATH}/modules)
...
set(OPENCV_SKIP_SYSTEM_PROCESSOR_DETECTION TRUE)
set(AARCH64 ${TARGET_IS_AARCH64})
set(X86_64 ${TARGET_IS_X86_64})
set(X86 ${TARGET_IS_X86})
set(ARM ${TARGET_IS_ARM})
###### ocv_options
...
set(OPENCV_FFMPEG_SKIP_BUILD_CHECK TRUE)
...
set(BUILD_ANDROID_PROJECT OFF)
set(BUILD_ANDROID_EXAMPLES OFF)
set(BUILD_PACKAGE OFF)
set(BUILD_PERF_TESTS OFF)
set(BUILD_TESTS OFF)
set(BUILD_WITH_DEBUG_INFO ON)
set(BUILD_WITH_STATIC_CRT ${BUILD_WITH_STATIC_CRT})
set(BUILD_JAVA OFF)
set(CURRENT_INSTALLED_DIR ${CURRENT_INSTALLED_DIR})
###### PROTOBUF
set(PROTOBUF_UPDATE_FILES ${BUILD_opencv_dnn})
set(UPDATE_PROTO_FILES ${BUILD_opencv_dnn})
###### PYLINT/FLAKE8
...
set(ENABLE_CXX11 ON)
###### OPENCV vars
set(OPENCV_DOWNLOAD_PATH ${DOWNLOADS}/opencv-cache)
set(OPENCV_OTHER_INSTALL_PATH share/opencv)
###### customized properties
## Options from vcpkg_check_features()
set(CMAKE_DISABLE_FIND_PACKAGE_Halide ON)
set(HALIDE_ROOT_DIR ${CURRENT_INSTALLED_DIR})
set(WITH_GTK OFF)
set(WITH_IPP ${WITH_IPP})
set(WITH_MATLAB OFF)
set(WITH_MSMF ${WITH_MSMF})
set(WITH_OPENMP ${WITH_OPENMP})
set(WITH_PROTOBUF ${BUILD_opencv_dnn})
set(WITH_OPENCLAMDBLAS OFF)
set(WITH_TBB ${WITH_TBB})
set(WITH_OPENJPEG OFF)
###### BUILD_options (mainly modules which require additional libraries)
set(BUILD_opencv_ovis ${BUILD_opencv_ovis})
set(BUILD_opencv_sfm ${BUILD_opencv_sfm})
set(BUILD_opencv_xfeatures2d ${BUILD_opencv_xfeatures2d})
set(BUILD_opencv_dnn ${BUILD_opencv_dnn})
###### The following modules are disabled for UWP
set(BUILD_opencv_quality ${BUILD_opencv_quality})
set(BUILD_opencv_gapi ${BUILD_opencv_gapi})
